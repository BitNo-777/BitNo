Contributing to bitno
============================

The bitno project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/BitNo-777/bitno/blob/master/doc/translation_process.md)
...
The following applies to code changes to the bitno project, and is not to be
confused with overall bitno Network Protocol consensus changes.

Whether a pull request is merged into bitno rests with the project merge
...
Patches that change bitno consensus rules are considerably more involved than
...
Where a patchset proposes to change the bitno consensus, it must have been
...
The project leader is the release manager for each bitno release.
