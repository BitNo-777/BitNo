...
The build script we'll be using is contained in the bitno github repository ([contrib/gitian-build.py](https://github.com/BitNo-777/bitno/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the bitno repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/BitNo-777/bitno/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, bitno-detached-sigs, and bitno GitHub repos.
