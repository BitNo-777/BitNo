...
The script [extract-osx-sdk.sh](https://github.com/BitNo-777/bitno/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
bitno/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/BitNo-777/bitno/blob/master/doc/README_osx.md) for troubleshooting tips.
