...
1. Clone the bitno source code:

        git clone https://github.com/BitNo-777/bitno
        cd bitno
...
bitno is now available at `./src/bitnod`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/bitno"

    touch "/Users/${USER}/Library/Application Support/bitno/bitno.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/bitno/bitno.conf"

The first time you run bitnod, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.

You can monitor the download process by looking at the debug.log file:

    tail -f $HOME/Library/Application\ Support/bitno/debug.log

Other commands:
-------

    ./src/bitnod -daemon # Starts the bitno daemon.
    ./src/bitno-cli --help # Outputs a list of command-line options.
    ./src/bitno-cli help # Outputs a list of RPC commands when the daemon is running.
