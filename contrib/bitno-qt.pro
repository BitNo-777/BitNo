...
RESOURCES += src/qt/bitno.qrc src/qt/bitno_locale.qrc

TRANSLATIONS += src/qt/locale/bitno_bg.ts \
                src/qt/locale/bitno_de.ts \
                src/qt/locale/bitno_en.ts \
                src/qt/locale/bitno_es.ts \
                src/qt/locale/bitno_fi.ts \
                src/qt/locale/bitno_fr.ts \
                src/qt/locale/bitno_it.ts \
                src/qt/locale/bitno_ja.ts \
                src/qt/locale/bitno_pl.ts \
                src/qt/locale/bitno_pt.ts \
                src/qt/locale/bitno_ru.ts \
                src/qt/locale/bitno_sk.ts \
                src/qt/locale/bitno_sv.ts \
                src/qt/locale/bitno_vi.ts \
                src/qt/locale/bitno_zh_CN.ts \
                src/qt/locale/bitno_zh_TW.ts
