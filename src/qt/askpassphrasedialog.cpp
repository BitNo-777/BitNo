...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            bitnoGUI* window = static_cast<bitnoGUI*>(parentWidget());
...
{
    bitnoGUI* gui = static_cast<bitnoGUI*>(parentWidget());
...
{
    hide();
    static_cast<bitnoGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("BitNo Coin will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your BITNOs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
