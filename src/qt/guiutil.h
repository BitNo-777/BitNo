...
/** Utility functions used by the bitno Qt UI.
 */
namespace GUIUtil
{
...
// Render bitno addresses in monospace font
...
// Parse "bitno:" URI into recipient object, return true on successful parsing
