...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, bitnoGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, bitnoGUI* gui, double posX = 3);
