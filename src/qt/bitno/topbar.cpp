...
#include "qt/bitno/topbar.h"
#include "qt/bitno/forms/ui_topbar.h"
#include "qt/bitno/lockunlock.h"
#include "qt/bitno/qtutils.h"
#include "qt/bitno/receivedialog.h"
#include "qt/bitno/loadingdialog.h"
...
TopBar::TopBar(bitnoGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopBITNO}, "amount-small-topbar");
    setCssProperty({ui->labelAmountBITNO}, "amount-topbar");
    setCssProperty({ui->labelPendingBITNO, ui->labelImmatureBITNO}, "amount-small-topbar");
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("bitno")
    updateDisplayUnit();
                            ...
                            const CAmount& delegatedBalance, const CAmount& coldStakedBalance)
{
    ...
    // BITNO Total
    QString totalBITNO = GUIUtil::formatBalance(balance, nDisplayUnit);

    // BITNO
    // Top
    ui->labelAmountTopBITNO->setText(totalBITNO);
    // Expanded
    ui->labelAmountBITNO->setText(totalBITNO);
    ui->labelPendingBITNO->setText(GUIUtil::formatBalance(unconfirmedBalance, nDisplayUnit));
    ui->labelImmatureBITNO->setText(GUIUtil::formatBalance(immatureBalance, nDisplayUnit));
}
