...
#include "qt/bitno/sendcustomfeedialog.h"
#include "qt/bitno/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(bitnoGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &bitnoGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
