...
#ifndef bitno_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define bitno_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //bitno_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
