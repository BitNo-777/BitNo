...
#include "qt/bitno/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/bitno/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(bitnoGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
           ...
           ui->labelNumber_UnspendableBITNO,
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableBITNO,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableBITNO,
    ...
    setCssProperty({
              ui->pushButton_Intro,
              ui->pushButton_UnspendableBITNO,
              ui->pushButton_Stake,
    ...
    connect(ui->pushButton_UnspendableBITNO, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableBITNO);});
    ...
    if (parent)
        connect(parent, &bitnoGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
