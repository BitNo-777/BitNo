...
#include "qt/bitno/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(bitnoGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &bitnoGUI::openFAQ);
