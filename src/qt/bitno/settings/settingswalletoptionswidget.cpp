...
#include "qt/bitno/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/bitno/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(bitnoGUI* _window, QWidget *parent) :
