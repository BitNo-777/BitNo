...
#include "qt/bitno/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/bitno/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(bitnoGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to bitnoGUI::handleRestart()
