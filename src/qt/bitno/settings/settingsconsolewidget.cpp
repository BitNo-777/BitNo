...
#include "qt/bitno/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/bitno/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(bitnoGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
	...
	message(CMD_REPLY, (tr("Welcome to the BitNo Coin RPC console.") + "<br>" +
