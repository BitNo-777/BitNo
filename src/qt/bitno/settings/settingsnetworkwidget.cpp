...
#include "qt/bitno/settings/settingsnetworkwidget.h"
#include "qt/bitno/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/bitno/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(bitnoGUI* _window, QWidget *parent) :
