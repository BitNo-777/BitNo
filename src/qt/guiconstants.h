...
/* bitno GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "BitNo Coin"
#define QAPP_ORG_DOMAIN "www.bitno.casino"
#define QAPP_APP_NAME_DEFAULT "BitNo Coin-Qt"
#define QAPP_APP_NAME_TESTNET "BitNo Coin-Qt-testnet"
