...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop BitNo Coin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "BitNo Coin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* bitno features */
        {"bitno", "listmasternodes", &listmasternodes, true, true, false},
        {"bitno", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bitno", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"bitno", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"bitno", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"bitno", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bitno", "masternodedebug", &masternodedebug, true, true, false},
        {"bitno", "startmasternode", &startmasternode, true, true, false},
        {"bitno", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bitno", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bitno", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bitno", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bitno", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bitno", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bitno", "preparebudget", &preparebudget, true, true, false},
        {"bitno", "submitbudget", &submitbudget, true, true, false},
        {"bitno", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bitno", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bitno", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bitno", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bitno", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bitno", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bitno", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bitno", "checkbudgets", &checkbudgets, true, true, false},
        {"bitno", "mnsync", &mnsync, true, true, false},
        {"bitno", "spork", &spork, true, true, false},
...
{
    return "> bitno-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:53331/\n";
}
